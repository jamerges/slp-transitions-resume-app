---
title: "SLP to Software Founder: Michelle Boisvert Built the Tool That Fixed Her Own Burnout"
slug: slp-to-software-founder-michelle-boisvert
metaDescription: "Michelle Boisvert stayed a school SLP and built easyReportPRO, report-writing software born from her own evaluation burnout. No outside funding, no coding background, and a husband who programmed it."
targetKeyword: slp software founder
secondaryKeywords:
  - slp report writing software
  - easyreportpro
  - slp entrepreneur
  - slp burnout paperwork
...
I once sat in an IEP meeting and realized I'd written the wrong student's name on a speech and language report. The parent didn't catch it. I had time to print a new copy, and I spent the following months combing every report I wrote for exactly that kind of detail.

That fear is the raw material for Boisvert's company. She's a school-based SLP who has worked with elementary and high school students in rural areas, and she traces her relationship with written errors back to middle school, when someone brought back something she'd written and, in her words, "highlighted all of the errors in it." She remembers it as humiliating. The anxiety followed her into clinical practice, where the documents carry a lot more weight than a middle-school essay. "With reports, things have to be accurate, they have to be error-free," she says, because these are legal documents delivered to teams.

By her mid-thirties, with a young family, she was doing what most of us do: taking the reports home. She describes watching how unhealthy that absence of work-life balance had become, and going looking for something that would fix it.

## What made her build software instead of leaving?

Boisvert had already done the technology thing once. Around 2008, while working on her PhD in Communication Disorders at UMass Amherst, she started investigating whether telepractice could extend clinical services, and built a company around it. That work became NetSLP, a division of WorldTide, Inc., and her dissertation research looked specifically at online service delivery for students with autism. She went on to edit ASHA's *Perspectives on Telepractice*.
...
## How do you put AI inside a legal document?

At the time of this conversation, in spring 2024, easyReportPRO had folded generative AI into parts of the platform, and Boisvert's approach to it was tightly constrained.

Sections like background information and educational history were checklist-driven: a clinician ticks off observations, and automation strings the selections into a paragraph. What came out was accurate, predictable, and stilted. Generative AI smoothed the prose without touching the content, and she was specific that the model had been trained not to change any of the core content the clinician selected, only the flow and cohesion.
...
easyReportPRO's public positioning today leads with automation and explicitly distances itself from AI. The site's own language is "Automation - Not AI," with the reasoning that SMART templates deliver predictable documents while preserving security and professional judgment. The FAQ doesn't mention AI at all. The company notes it doesn't collect identifiable client information, which is how it explains falling outside HIPAA requirements.

That's a real repositioning from a platform that, two years earlier, was demoing a generative feature in red highlight. It also isn't a reversal of anything Boisvert said on the show, since her original pitch was already about deterministic automation with AI in a narrow, disclosed, cosmetic role. She now teaches that distinction directly. Her August 2026 continuing-education course for SpeechPathology.com, "Leveraging AI and Automation to Support Clinical Professionals," is built around helping clinicians tell artificial intelligence and deterministic automation apart and choose between them.
...
Boisvert's path is unusual among the stories on this site because she never left. She's still a clinician. The business grew out of the exact task that was making the job unsustainable, which is a different move than finding a non-clinical role and different from starting over.
...
*This article summarizes a conversation from the Xceptional Leaders podcast, co-hosted by James Berges and Mai Ling Chan, for readers considering non-clinical work, supplemented with independent research on easyReportPRO and WorldTide, Inc. Product details, pricing, and business circumstances reflect the guest's account at the time of recording plus subsequent public information, and may have changed further since. Mai Ling Chan disclosed during the episode that she is an easyReportPRO affiliate.*
