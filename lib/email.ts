...
<div style="max-width:560px;margin:0 auto;padding:32px 20px;">
  ...
  <p style="font-size:15px;line-height:1.7;">Eight lessons, about fifty minutes, and every one ends with something to actually do. The decision tree and the sunk-cost audit are the two most people come back to. The <a href="${APP_URL}/api/course/workbook?f=pdf" style="color:#0B6B54;">companion workbook</a> is five printable pages for the parts worth writing by hand, and it opens with the same link above.</p>
