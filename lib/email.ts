...
<div style="max-width:560px;margin:0 auto;padding:32px 20px;">
  ...
  <p style="font-size:15px;line-height:1.7;">Eight lessons, about fifty minutes, and every one ends with something to actually do. The decision tree and the sunk-cost audit are the two most people come back to. Your <a href="${APP_URL}/course/workbook" style="color:#0B6B54;">workbook</a> fills in as you go and prints to PDF whenever you want it on paper.</p>
