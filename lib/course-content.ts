// Lesson content for Modules 2–7 lives in content/course/modules/module-N.json
...
import m7 from "@/content/course/modules/module-7.json";
...
const ALL: LessonContent[] = [m2, m3, m4, m5, m6, m7].flat() as LessonContent[];
