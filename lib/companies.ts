...
export const COMPANIES_DB: Company[] = [
  ...
  {"name": "Omada Health", "url": "omadahealth.com", "note": "A virtual-first, integrated care provider combining clinical protocols with behavior science for people managing chronic conditions.", "roles": ["Content", "Marketing", "Operations", "Product", "Project Management", "Research"], "categories": ["HealthTech"]},
  ...
  {"name": "Athelas", "url": "athelas.com", "note": "Remote Patient Monitoring (RPM) Programs gather remote health data from your patients, enabling preventative health in the home", "roles": ["Engineering", "Operations", "Sales"], "categories": ["HealthTech"]},
  ...
  {"name": "Cala Health", "url": "calahealth.com", "note": "Wearable neuromodulation; SLPs in customer success", "roles": ["Customer Success", "Clinical"], "categories": ["HealthTech"]},
  ...
  {"name": "Included Health", "url": "includedhealth.com", "note": "Care navigation; clinical licensing and compliance roles", "roles": ["Operations", "Clinical"], "categories": ["HealthTech"]},
  ...
  {"name": "WellSky", "url": "wellsky.com", "note": "Post-acute software; clinical product and implementation", "roles": ["Product", "Customer Success"], "categories": ["HealthTech", "Tech"]},
  {"name": "PointClickCare", "url": "pointclickcare.com", "note": "Long-term care EHR; implementation and clinical roles", "roles": ["Customer Success", "Product"], "categories": ["HealthTech", "Tech"]},
  ...
  {"name": "Health Catalyst", "url": "healthcatalyst.com", "note": "Healthcare data platform; clinical analytics roles", "roles": ["Data", "Customer Success"], "categories": ["HealthTech", "Tech"]},
  {"name": "Innovaccer", "url": "innovaccer.com", "note": "Healthcare data platform; clinical informatics", "roles": ["Data", "Customer Success"], "categories": ["HealthTech", "Tech"]},
  ...
  {"name": "WebPT", "url": "webpt.com", "note": "Rehab therapy software; clinical education and CS", "roles": ["Customer Success", "Content"], "categories": ["HealthTech", "Tech"]},
  ...
  {"name": "Constant Therapy Health", "url": "constanttherapyhealth.com", "note": "Cognitive-speech therapy app; SLP-founded science team", "roles": ["Clinical", "Product", "Research"], "categories": ["SLP-Adjacent", "HealthTech"]},
  {"name": "MedRhythms", "url": "medrhythms.com", "note": "Neurologic music therapy; clinician-built digital therapeutic", "roles": ["Clinical", "Product"], "categories": ["HealthTech"]},
  ...
  {"name": "IQVIA", "url": "iqvia.com", "note": "CRO; study coordinator and clinical research roles", "roles": ["Research", "Operations"], "categories": ["HealthTech"]},
