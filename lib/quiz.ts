...
export const PATHS: Record<string, QuizPath> = {
  ...
  "research-coordinator": {
    ...
    entryDoor: "University and academic medical center job boards, searched for \"study coordinator\" or \"research coordinator.\" No new credential is required to apply. Departments outside communication sciences — psychology, public health, aging, education — count your clinical experience just as much.",
...
export const QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      { label: "Built a program, caseload system, or workflow from scratch", scores: { "project-management": 4, "research-coordinator": 1 } },
      ...
      { label: "Handled authorizations, appeals, or insurance documentation", scores: { "liaison-ur": 4, "research-coordinator": 1 } },
  ...
  },
  {
    ...
    options: [
      { label: "Creating order from chaos — designing systems, moving projects forward", scores: { "project-management": 3, informatics: 1, "research-coordinator": 2 } },
  ...
  },
  {
    ...
    options: [
      { label: "I need to match or beat my SLP pay from day one", scores: { "liaison-ur": 3, "customer-success": 2, informatics: 2, "instructional-design": -2, "content-marketing": -1, "research-coordinator": -4 } },
      { label: "I can take a small dip for better conditions", scores: { "customer-success": 1, "project-management": 1, "research-coordinator": 2 } },
      ...
      { label: "Income matters less than hours and flexibility right now", scores: { "content-marketing": 2, "instructional-design": 1, "liaison-ur": 1, "research-coordinator": 3 } },
    ],
  },
  {
    id: "time",
    ...
    options: [
      { label: "Almost none — I'm running on empty", scores: { "liaison-ur": 3, "customer-success": 2, "clinical-educator": 1, "research-coordinator": 3, "data-analysis": -2, "instructional-design": -1 } },
      { label: "A couple of hours a week", scores: { "customer-success": 1, informatics: 1, "research-coordinator": 2 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "I want people contact, but as accounts and colleagues — not a caseload", scores: { "customer-success": 3, "liaison-ur": 2, "project-management": 1, "research-coordinator": 1 } },
      { label: "I'd rather influence people through systems, data, or content", scores: { "data-analysis": 3, informatics: 2, "content-marketing": 2, "instructional-design": 2, "research-coordinator": 2 } },
      { label: "I want as little live people-time as possible for a while", scores: { "data-analysis": 3, informatics: 3, "instructional-design": 1, "content-marketing": 1, "research-coordinator": 2 } },
    ],
  },
  {
    id: "proximity",
    ...
    options: [
      { label: "I want to stay close to clinical — that knowledge is my edge", scores: { "liaison-ur": 3, informatics: 2, "clinical-educator": 3, "research-coordinator": 1 } },
      { label: "Clinical-adjacent, but out of direct care", scores: { "customer-success": 2, informatics: 2, "instructional-design": 1, "research-coordinator": 3 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "I learn what I need, when I need it", scores: { "customer-success": 1, "project-management": 1, "content-marketing": 2, "research-coordinator": 2 } },
