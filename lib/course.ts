...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "3.4", module: 3, title: "Why your cover letter sounds like the other 34", type: "video", minutes: 6, summary: "" },
      ...
      { id: "3.7", module: 3, title: "The cover letter, and why it only works if it cost you something", type: "video", minutes: 6, summary: "" },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "4.4", module: 4, title: "Keeping the paycheck while you leave", type: "video", minutes: 7, summary: "" },
      { id: "4.5", module: 4, title: "The loan is a calendar: PSLF, the pay-cut budget, COBRA", type: "interactive", minutes: 9, summary: "" },
      { id: "4.6", module: 4, title: "500 applications, or one person who'll vouch for you", type: "video", minutes: 7, summary: "" },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "5.6", module: 5, title: "113 applications, 7 interviews, 1 offer", type: "video", minutes: 6, summary: "" },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "6.3", module: 6, title: "Answer one message from someone in Module 2", type: "action", minutes: 10, summary: "" },
    ],
  },
];
