...
POSTS = {
    "slp-transferable-skills": dict(
        ...
        faqs=[
            ("What are the most valuable transferable skills for an SLP leaving clinical work?",
             "The ones that map to a business outcome. Sounding clinical earns nothing. Caseload management translates to managing a portfolio of concurrent clients; IEP meetings translate to cross-functional stakeholder alignment; progress monitoring translates to outcome analytics and data-driven decisions; and explaining a diagnosis to a frightened parent translates to plain-language communication for non-expert users. \"Communication skills\" and \"empathy\" do not set you apart, because every applicant claims them."),
    ...
    "slp-resume-non-clinical": dict(
        ...
        cta="Ready to have your actual resume translated?",
        faqs=[
            ...
            ("Will an ATS automatically reject my resume?",
             "Auto-rejection purely on a match score is rare, and largely a myth. Applicant tracking systems mostly rank and sort; people make the reject decision. What genuinely hurts you is a resume the system cannot parse: multi-column layouts, text inside tables or graphics, and non-standard section headers."),
            ...
            ("How long should a non-clinical SLP resume be?",
             "One page if you have under ten years of experience, two at most beyond that. Relevance beats completeness: a hiring manager needs to believe you can do the job you want, and a full inventory of everything you have done gets in the way of that."),
        ],
    ...
    "slp-linkedin-career-change": dict(
        ...
        faqs=[
            ("What should my LinkedIn headline say if I am an SLP changing careers?",
             "Point it at where you are going while keeping the credibility of where you have been. \"Speech-Language Pathologist\" alone tells recruiters you are clinical and closed. A headline naming the target function plus your clinical grounding, credential included, signals both direction and proof."),
            ...
            ("How do recruiters find career changers on LinkedIn?",
             "They search the vocabulary of the role they are filling. The vocabulary of the role you are leaving never enters the query. If your profile only contains clinical terms, you are invisible to every search that matters. The About section and skills list are where that language has to appear."),
            ("Does posting on LinkedIn actually help a career change?",
             "It compounds, but it is slower than outreach. Direct messages to people who made the same move produce replies at roughly one in four. That is a normal hit rate, so expect three silences for every reply. Referrals decide more transitions than applications do."),
        ],
        links=[(r"\bresume\b", f"{SITE}/slp-resume-non-clinical/"),
               (r"\balternative careers\b", PILLAR)],
    ),
    "should-you-quit-slp": dict(
        ...
        faqs=[
            ("Should I quit being an SLP?",
             "That is the wrong first question, because it is a binary and your situation is not. The useful questions are narrower: is the problem the profession, the setting, or the specific employer? Is the constraint money, time, or identity? People who leave successfully usually answer those before they answer the big one. Some discover the fix is a different job in the same field."),
            ("Am I wasting my degree if I leave clinical work?",
             "The degree bought you a way of thinking: behavioral science, data-driven decisions, and the ability to explain complex things to people under stress. None of that expires when you stop billing sessions. Several documented paths pay at or above clinical rates precisely <em>because</em> of the credential, including clinical liaison, utilization review, and clinical educator roles at AAC and device companies."),
            ...
            ("Will I take a pay cut if I leave clinical work?",
             "Not necessarily, and that assumption stops more people than the actual numbers justify. Customer success and implementation roles at health-tech and speech-tech companies commonly run $75,000–$120,000; clinical liaison roles run $80,000–$135,000; clinical informatics runs higher still. Some paths involve a dip. Plenty do not."),
        ],
