    ...
    "slp-to-software-engineer-jeannette-roberes": dict(
        ...
        faqs=[
            ("Can a speech-language pathologist become a software engineer?",
             "Yes. Jeannette Roberes completed a coding program in three months and then worked as a software engineer for about two and a half years, having previously been a school-based SLP specialising in dyslexia. She is candid about what kept her out of technology for years: the belief that it meant maths and engineering, and therefore was not for a self-described liberal arts person. She had the capability the whole time."),
            ("How long does a coding bootcamp take?",
             "Roberes finished hers in three months. Bootcamps generally run between three and six months full time, or longer part time. The more useful framing from her story is the question she asked before applying: what is the best thing that could happen? Either she got in and learned to build software, or she did not and continued as an SLP, a floor she was already comfortable with."),
            ("Is it a failure to leave a career you just retrained for?",
             "Not necessarily. Roberes could do the work. She left software engineering after two and a half years because the daily rigour of it did not suit her temperament. She then combined both backgrounds into speaking, consulting, and writing about clinicians and dyslexic thinkers in technology, work neither credential would have qualified her for alone."),
            ("What is the difference between access and accessibility?",
             "Roberes frames it this way: access invites you to pull a seat up to the table, while accessibility welcomes you to engage in the dialogue at the table. It is a useful filter when evaluating an employer during a transition. Many organisations will offer access: an interview, an offer, a seat. Far fewer are built so that your particular way of working is genuinely usable once you are there."),
        ],
    ...
    "building-a-startup-without-quitting-alan-vu": dict(
        ...
        faqs=[
            ("Can I build a business while working full time as an SLP?",
             "Alan Vu does, though he says plainly that he would not recommend running four things at once. Extra hours are not the answer. Two decisions make it workable: prioritising ruthlessly, and delegating the venture that has matured enough to run without him. He has an executive assistant running his e-commerce business day to day, which is what frees his attention for the app he is building and for his students."),
            ("Should I quit my clinical job before starting something?",
             "Vu's case argues against it. Working daily at a school with non-speaking students who use AAC means he watches the problem he is solving happen in front of him, including parents struggling with complicated interfaces. That access to real users is worth more than the extra hours quitting would buy, and the job also funds the build."),
            ("What is AAC?",
