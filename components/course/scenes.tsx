...
export const STAGE_META = [
  { key: "private", n: 1, name: "Private doubt", belief: "Looking means deciding.", truth: "Looking is research. You can read all of this and still be a clinician on Monday.", move: "Work out which problem you have: bad workplace, bad fit, or bad season.",
    voice: "Maybe it's just a problem with my brain and not the job.", from: "a school SLP, r/slp" },
  { key: "guilt", n: 2, name: "Guilt and identity", belief: "Leaving wastes the degree.", truth: "The degree goes with you. Every path on the map runs on it.", move: "Read the five fears so they stop running things from the back seat.",
    voice: "One thing I'm struggling with the most is the feeling that I'm \u2018throwing away\u2019 my degree.", from: "r/SLPcareertransitions" },
  { key: "permission", n: 3, name: "Permission-seeking", belief: "It works for other people, not me.", truth: "Jeannette, Rachel and Mattie started where you are, with no shortcut.", move: "Pick one story with your starting point. Copy its first month.",
  ...
  { key: "action", n: 5, name: "Action", belief: "If I were good enough, I'd get callbacks.", truth: "You're qualified. The r\u00e9sum\u00e9 still says caseload where a recruiter needs to read clients.", move: "Fix the r\u00e9sum\u00e9 before the next application.",
...
export const threeLiesScenes: Scene[] = [
  { id: "open", ms: 4200, caption: "Three things SLPs believe when they want out. All three are wrong, and each one keeps people in the building longer than they need to be.",
    render: () => (<><Kicker>Module 0 · Lesson 4</Kicker><Big>Three things I believed.</Big><Sub>About a minute each. Most people hold at least one of them.</Sub></>) },
  ...LIES.map((l, i): Scene => ({
